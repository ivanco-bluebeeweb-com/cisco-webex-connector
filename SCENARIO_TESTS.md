# Plausible Scenario Tests (PST) — Cisco Webex Connector
...
- `connect_webex`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_webex`: validated contract & error handling
...
- `list_rooms`: validated contract & error handling
